      ...
      analyzer.arg_names.flat_map do |arg|
        types[arg].flat_map do |arg_type|
          ...
          analyzer.arg_sends[arg].flat_map do |arg_send|
            ...
            bad_arg_send_message(klass_sym, method_sym, arg, type_class, arg_send)
          end
        end
      end.compact
    end

    def bad_arg_send_message(klass_sym, method_sym, arg_name, arg_type, arg_send)
      "The method #{klass_sym}##{method_sym} as type sampled may receive a "\
